...
|---|---:|---:|---:|
| Lexical retrieval | Recall@5 | 50.0% (95% CI 30.0%–70.0%) | 20 |
| Lexical retrieval | MRR | 50.0% (95% CI 30.0%–70.0%) | 20 |
...
- **Easy** — Recall@5 50.0%, 95% CI 16.7%–83.3% (n=6).
- **Medium** — Recall@5 57.1%, 95% CI 14.3%–85.7% (n=7).
- **Hard** — Recall@5 42.9%, 95% CI 14.3%–85.7% (n=7).
